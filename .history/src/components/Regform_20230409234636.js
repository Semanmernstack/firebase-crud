...
import { db, storage } from '../firebase.'
 ...
 function Regform ({  age, firstName, id, lastName }) {
  ...
  const upLoading = async () => {
    ...
    const uploadTask = await uploadBytesResumable(storageRef, fileUpload)
  ...
  return (
    ...
    <div className="flex flex-col  p-4 gap-3 my-2  rounded-2xl w-5/12">
      <div className="shadow-2xl border p-3 w-[600px]">
        <div className=''>
